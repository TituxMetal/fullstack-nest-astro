...
describe('PasswordValueObject', () => {
  describe('constructor', () => {
    ...
    it('should throw error for null or undefined', () => {
      expect(() => new PasswordValueObject(null as string)).toThrow('Password is required')
      expect(() => new PasswordValueObject(undefined as string)).toThrow('Password is required')
    })
