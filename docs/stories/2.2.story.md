...
- `apps/backend/src/auth/domain/entities/AuthUser.entity.ts`
- `apps/backend/src/auth/domain/entities/AuthUser.entity.spec.ts`
- `apps/backend/src/auth/domain/entities/index.ts`
- `apps/backend/src/auth/domain/value-objects/Email.vo.ts`
- `apps/backend/src/auth/domain/value-objects/Email.vo.spec.ts`
- `apps/backend/src/auth/domain/value-objects/Password.vo.ts`
- `apps/backend/src/auth/domain/value-objects/Password.vo.spec.ts`
- `apps/backend/src/auth/domain/value-objects/index.ts`
- `apps/backend/src/auth/domain/repositories/AuthUser.repository.ts`
- `apps/backend/src/auth/domain/repositories/index.ts`
- `apps/backend/src/auth/domain/exceptions/InvalidCredentials.exception.ts`
- `apps/backend/src/auth/domain/exceptions/index.ts`

Application Layer:

- `apps/backend/src/auth/application/use-cases/Login.uc.ts`
- `apps/backend/src/auth/application/use-cases/Login.uc.spec.ts`
- `apps/backend/src/auth/application/use-cases/Register.uc.ts`
- `apps/backend/src/auth/application/use-cases/Register.uc.spec.ts`
- `apps/backend/src/auth/application/use-cases/Logout.uc.ts`
- `apps/backend/src/auth/application/use-cases/Logout.uc.spec.ts`
- `apps/backend/src/auth/application/use-cases/index.ts`
- `apps/backend/src/auth/application/dtos/Login.dto.ts`
- `apps/backend/src/auth/application/dtos/Register.dto.ts`
- `apps/backend/src/auth/application/dtos/index.ts`
- `apps/backend/src/auth/application/services/Auth.service.ts`
- `apps/backend/src/auth/application/services/index.ts`
- `apps/backend/src/auth/application/mappers/AuthUser.mapper.ts`
- `apps/backend/src/auth/application/mappers/index.ts`

Infrastructure Layer:

- `apps/backend/src/auth/infrastructure/repositories/PrismaAuthUser.repository.ts`
- `apps/backend/src/auth/infrastructure/repositories/index.ts`
- `apps/backend/src/auth/infrastructure/services/Password.service.ts`
- `apps/backend/src/auth/infrastructure/services/Jwt.service.ts`
- `apps/backend/src/auth/infrastructure/services/index.ts`
- `apps/backend/src/auth/infrastructure/controllers/Auth.controller.ts`
- `apps/backend/src/auth/infrastructure/controllers/index.ts`
- `apps/backend/src/auth/infrastructure/guards/JwtAuth.guard.ts`
- `apps/backend/src/auth/infrastructure/guards/index.ts`
- `apps/backend/src/auth/infrastructure/decorators/GetCurrentUser.decorator.ts`
- `apps/backend/src/auth/infrastructure/decorators/index.ts`
- `apps/backend/src/auth/infrastructure/mappers/AuthUser.mapper.ts`
- `apps/backend/src/auth/infrastructure/mappers/index.ts`
...
- `apps/backend/src/app.module.ts` - Updated import path to new Auth.module
- `apps/backend/src/user/user.controller.ts` - Updated import paths to new auth structure
...
- `apps/backend/src/auth/decorators/` (directory)
- `apps/backend/src/auth/dto/` (directory)
- `apps/backend/src/auth/guards/` (directory)
- `apps/backend/src/auth/types/` (directory)
