...
- [ ] **Task 4: Update Import Paths Across Codebase** (AC: 2.4.4)
  - [ ] Update `apps/api/src/users/User.controller.spec.ts` TokenService import
  - [ ] Update `apps/api/src/users/Users.module.ts` to import from Auth module instead of Token
        module
  - [ ] Update `apps/api/src/app.module.ts` to remove TokenModule import
...
- [ ] **Task 5: Remove Token Module** (AC: 2.4.5)
  ...
  - [ ] Remove `apps/api/src/token/` directory completely
...
- `apps/api/src/auth/domain/value-objects/JwtPayload.vo.ts`
- `apps/api/src/auth/domain/value-objects/JwtPayload.vo.spec.ts`

Infrastructure Layer:

- `apps/api/src/auth/infrastructure/services/Token.service.ts`
- `apps/api/src/auth/infrastructure/services/Token.service.spec.ts`

**Files to be Modified:**

- `apps/api/src/auth/Auth.module.ts` - Add JWT module configuration and TokenService
...
- `apps/api/src/users/User.controller.spec.ts` - Update TokenService import path
- `apps/api/src/users/Users.module.ts` - Remove TokenModule import, use Auth module
- `apps/api/src/app.module.ts` - Remove TokenModule import

**Files to be Deleted:**

- `apps/api/src/token/` (entire directory)
