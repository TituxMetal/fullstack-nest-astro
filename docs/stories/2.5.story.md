...
- `apps/api/src/app.module.ts` - Import PrismaModule → DatabaseModule
- `apps/api/src/auth/Auth.module.ts` - Import PrismaModule → DatabaseModule
...
- `apps/api/src/shared/domain/repositories/BaseRepository.interface.ts`
- `apps/api/src/shared/domain/repositories/index.ts`
...
- `apps/api/src/shared/infrastructure/database/UnitOfWork.service.ts`
- `apps/api/src/shared/infrastructure/database/index.ts`
- `apps/api/src/shared/infrastructure/repositories/BaseRepository.abstract.ts`
- `apps/api/src/shared/infrastructure/repositories/RepositoryFactory.service.ts`
- `apps/api/src/shared/infrastructure/repositories/index.ts`

Test Files:

- `apps/api/src/shared/domain/repositories/BaseRepository.interface.spec.ts`
- `apps/api/src/shared/infrastructure/repositories/BaseRepository.abstract.spec.ts`
- `apps/api/src/shared/infrastructure/database/UnitOfWork.service.spec.ts`
- `apps/api/src/shared/infrastructure/repositories/RepositoryFactory.service.spec.ts`

**Files to be Modified:**

- `apps/api/src/app.module.ts` - Import DatabaseModule instead of PrismaModule
- `apps/api/src/auth/Auth.module.ts` - Update to use shared database infrastructure
- `apps/api/src/auth/infrastructure/repositories/PrismaAuthUser.repository.ts` - Extend
  BaseRepository
- `apps/api/src/users/Users.module.ts` - Update Prisma imports to use shared location
