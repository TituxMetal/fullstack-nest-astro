...
acceptance_criteria:
  # Directory Structure
  - 'AC2.1.1: Create `apps/api/src/contexts/` directory structure with auth/, user/, and shared/
    bounded contexts, each containing domain/, application/, and infrastructure/ layers'
  - 'AC2.1.2: Add architectural documentation in `apps/api/docs/architecture.md` explaining Clean
...
- [x] **Task 1: Create Clean Architecture Directory Structure** (AC: 2.1.1)
  - [x] Create `apps/api/src/contexts/` root directory
...
- [x] **Task 2: Create Architectural Documentation** (AC: 2.1.2)
  - [x] Create `apps/api/docs/` directory
  - [x] Write `apps/api/docs/architecture.md` with Clean Architecture + DDD principles
...
- Backend is located at `apps/api/` [Source: docs/architecture/source-tree.md#Target Project
  Structure]
...
1. ✅ **Directory Structure Created**: Complete contexts/ hierarchy with auth/, user/, shared/
   bounded contexts
2. ✅ **Architecture Documentation**: Comprehensive `apps/api/docs/architecture.md` with Clean
   Architecture + DDD principles
...
- `apps/api/src/contexts/` - Root contexts directory
- `apps/api/src/contexts/auth/domain/` - Auth domain layer
- `apps/api/src/contexts/auth/application/` - Auth application layer
- `apps/api/src/contexts/auth/infrastructure/` - Auth infrastructure layer
- `apps/api/src/contexts/user/domain/` - User domain layer
- `apps/api/src/contexts/user/application/` - User application layer
- `apps/api/src/contexts/user/infrastructure/` - User infrastructure layer
- `apps/api/src/contexts/shared/domain/` - Shared domain layer
- `apps/api/src/contexts/shared/infrastructure/` - Shared infrastructure layer
- `apps/api/docs/architecture.md` - Architectural documentation
- `apps/api/src/contexts/shared/domain/entities/_template.entity.ts` - Domain entity template
- `apps/api/src/contexts/shared/domain/repositories/_template.repository.ts` - Repository interface
  template
- `apps/api/src/contexts/shared/application/useCases/_template.usecase.ts` - Use case template
- `apps/api/src/contexts/shared/infrastructure/repositories/_template.repository.ts` - Repository
  implementation template
- `apps/api/src/contexts/shared/infrastructure/controllers/_template.controller.ts` - Controller
  template
...
**Exceptional architectural documentation** (apps/api/docs/architecture.md):
