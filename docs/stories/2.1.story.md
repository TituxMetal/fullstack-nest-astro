...
acceptance_criteria:
  ...
  - 'AC2.1.2: Add architectural documentation in `apps/api/docs/architecture.md` explaining
...
- `apps/api/src/contexts/shared/domain/repositories/_template.repository.ts` - Repository
  interface template
- `apps/api/src/contexts/shared/application/useCases/_template.usecase.ts` - Use case template
- `apps/api/src/contexts/shared/infrastructure/repositories/_template.repository.ts` -
